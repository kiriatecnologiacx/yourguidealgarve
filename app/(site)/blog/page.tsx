        ...
        {featured ? (
          ...
          >
            ...
            <div className="p-6 md:p-8 flex flex-col justify-center">
              ...
              <h2 className="font-display mt-2 text-2xl md:text-3xl font-extrabold text-text-strong leading-tight">
                {featured.title}
              </h2>
              {featured.excerpt ? (
            ...
            {rest.map((p) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <h3 className="font-display mt-1 text-[17px] font-bold text-text-strong leading-snug line-clamp-2">
                    {p.title}
                  </h3>
                  {p.excerpt ? (
